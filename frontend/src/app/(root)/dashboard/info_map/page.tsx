          ...
          .map((item) => {
            const highestCijena =
              item.parking_data.cijena.length > 0
                ? Math.max(...item.parking_data.cijena.map((c) => c.cijena))
        ...
        <Select onValueChange={handleSelectChange}>
          ...
          <SelectContent className="bg-white/50">
            <SelectGroup>
              ...
              <SelectItem value="charger">SuperChargers</SelectItem>
        ...
        {infoModal && selectedParking && (
          ...
          >
            <div className="bg-white p-4 rounded shadow-lg">
              ...
              <p>
                <strong>Free Spaces:</strong> {selectedParking.slobodno}
              </p>
              <p>
                <strong>Capacity:</strong> {selectedParking.kapacitet}
              </p>
              <p>
              ...
              <p>
                ...
                {formatWorkingHours(selectedParking.vrijeme_naplate)}
              </p>
              <button
