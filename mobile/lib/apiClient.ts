 ...
 */
export const getLinije =
  async (): Promise<StringModelLinijaDictionaryResponse> => {
 ...
 */
export const getStanice =
  async (): Promise<Int32ModelStanicaDictionaryResponse> => {
 ...
 */
export const getPolasci =
  async (): Promise<StringModelLinijaPolazakStanicaDictionaryResponse> => {
