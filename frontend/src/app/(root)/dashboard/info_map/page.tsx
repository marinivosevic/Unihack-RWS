...
.map((item) => {
const highestCijena = item.parking_data.cijena.length > 0
...
console.log(`Parking marker "${parking.parking_name}" was clicked.`);
}}
...
<Overlay
anchor={[selectedParking.lokacija.lat, selectedParking.lokacija.lng]}
offset={[120, 79]}
